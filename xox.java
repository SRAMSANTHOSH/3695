...
public class xox extends Applet
...
this.ch[0] = 'R';
            ...
            if ((x > 200) && (x < 400) && (y < 200) && (this.ch[0]!='R') ) 
{ this.m = 200; this.n = 0; this.ch[1] = 'R'; }
            ...
            if ((x > 200) && (x < 400) && (y > 200) && (y < 400)&& (this.ch[0]!='R')) { this.m = 200; this.n = 200; this.ch[4] = 'R'; }
        ...
        if (this.flag == 0)
        {
            if ((x < 200) && (y < 200) && (this.ch[0]!='R')) { this.m = 0; this.n = 20; this.ch[0] = 'P'; }
